...
import Settings from "./Settings"; // ✅ Correct import path to your Settings file

const Sidebar = ({ onSelect }) => {
  return (
    <aside className="w-[30%] h-screen bg-gray-100 p-6 flex flex-col justify-between">
      <div>
...
export default function AccountLayout() {
  ...
  return (
    <div className="flex h-screen">
      ...
      <main className="w-[70%] overflow-y-auto bg-white">
